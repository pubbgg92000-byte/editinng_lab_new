...
export const load = async ({ locals, url }) => {
	let settings: StudioSettings = { studioName: 'StudioFlow', orderPrefix: 'ORD', editorPrefix: 'ED', logoUrl: '', address: '', phone: '', email: '', gstin: '', paymentNote: '', invoiceFooter: '', assignmentTemplate: '', invoiceTemplate: '', themePalette: 'graphite-aqua', themeDefaultMode: 'light' };
