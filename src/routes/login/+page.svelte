...
<style>
	...
	@media(max-width:420px){.login-page{padding:10px 8px 22px}.login-shell{border-radius:17px}.login-card{padding:24px 18px}.login-card h1{font-size:25px}.eyebrow{margin-top:14px}.login-card input{height:46px}.primary{height:48px}.support{font-size:7.5px}}
</style>
