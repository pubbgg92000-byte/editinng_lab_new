...
const definitions = [
	...
	{ name: 'Orders', columns: ['Order ID', 'Customer', 'Project', 'Work type', 'Files', 'Due date', 'Price', 'Status'], demo: orders.map((o) => [o.id, o.customer, o.project, o.workType, o.files, o.due, o.price, o.status]) },
	...
	{ name: 'Settings', columns: ['Key', 'Value'], demo: [['Studio name', 'Arvind Studio'], ['Google Sheets sync', 'Demo mode'], ['WhatsApp notifications', 'Demo mode'], ['Default currency', 'INR']] }
];
