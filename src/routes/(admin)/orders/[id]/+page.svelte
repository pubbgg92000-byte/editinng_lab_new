...
<style>
	...
	@media(max-width:760px){.detail-top{align-items:flex-start;flex-direction:column;gap:14px}.actions{width:100%;display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.actions button{min-height:46px;white-space:normal}.task-row{grid-template-columns:1fr auto}.task-progress{grid-column:1}.task-actions{grid-column:2;grid-row:1/3}.side-col{grid-template-columns:1fr}.customer-orders-card{grid-column:auto}.customer-heading{align-items:flex-start;flex-direction:column;gap:2px}}
</style>
