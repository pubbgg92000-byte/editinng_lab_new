...
export const POST = async ({ request, cookies, locals }) => {
	...
	try { input.customFields = hasCapability(configuration.effectiveCapabilities, 'customFields') ? validateCustomValues(configuration.profile, 'customer', input.customFields) : {}; }
